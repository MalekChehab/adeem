...
class ProductsPage extends StatelessWidget {
  ...
  final List<Product> breadProducts = [
    Product(
      ...
      imagePath: 'assets/whole_grain_bread.jpg',
    ),
    Product(
      ...
      imagePath: 'assets/multi_seed_bread.png',
    ),
    Product(
      ...
      imagePath: 'assets/sourdough_bread.jpg',
    ),
  ];
